...
<div class="flex w-9/12 items-start justify-center md:justify-between">
	...
	>
		...
		<section class="w-full flex flex-col h-fit my-2  shadow-xl ">
			...
			/>
			<!--profile pic-->
			<section class="relative bottom-11 left-1/3 lg:left-1/3">
				<!-- svelte-ignore a11y-img-redundant-alt -->
				<img
					class="h-20 w-20 object-cover rounded-full border-2 border-white  absolute left-4 lg:left-9 "
			...
			<section class="flex items-center justify-evenly m-2">
				<h4 class="text-green" id="timerCountdown">10:22</h4>
