...
>
			...
			{#each contacts as contact}
				...
				>
					...
					<section class="flex  items-center  ">
						<!--profile img-->
						<a href="profile/{contact.userName}" class="lg:w-6/12 w-fit">
							<!-- svelte-ignore a11y-img-redundant-alt -->
							<img
								class="h-12 w-13 lg:w-12 object-cover rounded-full  "
	...
	<section class="md:w-9/12 flex flex-col w-full ">
		...
		<section class="flex items-center w-full border-b-main-bg border-2 py-2 px-3  ">
			...
			<h4 class=" font-semibold text-sm text-gray-900 mx-4 flex-1">Ali saadatNia</h4>
			<h5 class="text-xs text-orange mx-2 cursor-default">timeRemian</h5>
		</section>
		<!--Middle part-->
		<section class="flex-1 m-2 overflow-y-auto overflow-x-hidden flex flex-col" id="middlePart">
			<section class="w-full">
				<h1 class="send-message">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, architecto. Nemo, illo
					quibusdam. Asperiores maxime aut voluptas nobis dolores voluptates?
				</h1>
			</section>
			<h1 class="receive-message">
				Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur, quod sint repellendus
				dicta laudantium totam maxime unde est ratione numquam.
			</h1>
		</section>
		<!--bottom part-->
		<section class="">
