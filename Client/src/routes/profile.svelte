...
>
	...
	<div class="flex  justify-between items-center md:p-4  gap-4 flex-col  w-96 md:mr-32 lg:mr-0">
		<!--profile info-->
		<section class="w-full flex flex-col h-fit my-2  shadow-xl ">
			<!--profile banner-->
			<img
				class="object-cover w-full h-36 md:rounded-md"
				src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1vcj4am90OC3A5b3ydxn4HYkkmh0CuDgifpN1w53EUNts_GAd3agLBzIg9s2_yH17CZU&usqp=CAU"
				alt=""
			/>
			<!--profile pic-->
			<section class="relative bottom-11 left-1/3">
				<!-- svelte-ignore a11y-img-redundant-alt -->
				<img
					class="h-20 w-20 object-cover rounded-full border-2 border-main  absolute left-4 "
			...
			<!--Name & UserName & Bio-->
			<section class=" mt-11 mx-2 w-fit flex flex-col items-center mb-2">
				<h4 class=" font-semibold text-base text-gray-900 my-1 text-center">Mehdi Gholami</h4>
				<h5 class=" text-xs  text-gray-900 font-semibold  my-1  text-center w-9/12 mx-auto">
					Mr_Gholam
				</h5>
				<h5 class="text-sm my-1 text-center">
					Use h-full to set an element’s height to 100% of its parent, as long as the parent has a
					defined height.
				</h5>
			</section>
			<!--time & buttons-->
			<section class="flex items-center justify-evenly m-2">
				<h4 class="text-green ">10:22</h4>
